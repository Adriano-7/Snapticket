...
INSERT INTO Comment (date, content, user_id, ticket_id) VALUES ('2023-05-04 23:30:25','Thanks for the information, Christopher. That clears things up for me.', 10, 5);
...
INSERT INTO Comment (date, content, user_id, ticket_id) VALUES ('2023-05-06 09:22:15','Hi Scott, have you checked if all transactions have been recorded correctly in QuickBooks? Sometimes missing or duplicated transactions can cause issues when reconciling accounts.', 1, 10);
...
INSERT INTO Comment (date, content, user_id, ticket_id) VALUES ('2023-05-06 11:50:15','Scott, can you provide me with the bank statement, so I can take a closer look at the transactions? You can email it to me directly.', 1, 10);
...
INSERT INTO Comment (date, content, user_id, ticket_id) VALUES ('2023-05-06 9:30:15','Thanks, I think the issue is solved. I appreciate your prompt response!', 9, 7);
...
INSERT INTO Comment (date, content, user_id, ticket_id) VALUES ('2023-05-12 09:30:15','I have assigned you to ticket #15 regarding an incorrect tax filing submitted to the IRS for a client. Please let me know if you have any questions or need further information.', 1, 15);
INSERT INTO Comment (date, content, user_id, ticket_id) VALUES ('2023-05-12 10:30:15','Thanks for assigning the ticket to me. Could you please provide me with the client name and the details of the incorrect filing?', 8, 15);
INSERT INTO Comment (date, content, user_id, ticket_id) VALUES ('2023-05-12 10:45:15','The client name is John Smith, and the incorrect filing was related to their business tax return. I have uploaded the relevant documents to the ticket for your reference.', 1, 15);
INSERT INTO Comment (date, content, user_id, ticket_id) VALUES ('2023-05-12 11:10:15','Thank you for the information. I will review the documents and work on resolving the issue. Ill keep you updated on my progress.', 8, 15);
INSERT INTO Comment (date, content, user_id, ticket_id) VALUES ('2023-05-12 16:34:15','I have reviewed the documents and have identified the issue. I will submit a revised tax filing to the IRS. I will also update the client on the status of the filing. Please let me know if you have any questions or need further information.', 8, 15);
INSERT INTO Comment (date, content, user_id, ticket_id) VALUES ('2023-05-12 16:39:00','Thanks for your help.', 1, 15);
