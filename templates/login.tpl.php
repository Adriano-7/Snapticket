    ...
    <body>
        ...
        <?php function drawRightText(){ ?>
            ...
            <?php function drawLoginForm($failedLogin){ ?>
                <?php if ($failedLogin) { ?>
                    <p class="error_msg">Invalid username or password</p>
                <?php } ?>
                <form action="../actions/login.action.php" method="post">
                    <input type="text" name="username" placeholder="username" <?php if ($failedLogin) { ?> class="error_box"
                        <?php } ?>>
                    <br>
                    <input type="password" name="password" placeholder="password" <?php if ($failedLogin) { ?>
                            class="error_box" <?php } ?>>
