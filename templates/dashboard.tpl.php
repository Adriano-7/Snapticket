...
<?php function drawTicketsTable(array $tickets, PDO $db){ ?>
  <table class="tickets_table">
    ...
    <tr class="ticket_row" onclick="window.location.href='ticket.php?ticket_id=<?php echo $ticket->ticket_id; ?>'">
      <td class="tickets_id">
        ...
        <td class="tickets_assignee"><?php if ($ticket->assignee === null) { echo ''; } else { echo $ticket->assignee->username; } ?></td>
