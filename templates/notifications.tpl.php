...
<main>
    ...
    <?php foreach($notifications as $notification){ ?>
        <div class="notification">
            ...
            <a class="notification_delete" href="../actions/notification/eliminate_notification.action.php?notification_id=<?php echo $notification->notification_id ?>"> <img src="../assets/cross-icon.svg" alt="Remove notification"> </a>
        </div>
    <?php } ?>
    </div>
</main>
