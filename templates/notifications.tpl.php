...
<main>
    ...
    <?php foreach($notifications as $notification){ ?>
        <div class="notification">
            <a class="notification_details" href="../actions/notification/notificationRedirect.action.php?notification_id=<?php echo $notification->notification_id ?>">
                ...
                <a class="notification_delete" href="../actions/notification/eliminateNotification.action.php?notification_id=<?php echo $notification->notification_id ?>"> <img src="../assets/icons/cross-icon.svg" alt="Remove notification"> </a>
            </div>
            </a>
        </div>
    <?php } ?>
